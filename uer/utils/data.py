...
class BertDataLoader(object):
    ...
    def __iter__(self):
        while True:
            ...
            yield paddle.to_tensor(src,dtype='int64'), \
                paddle.to_tensor(tgt_mlm,dtype='int64'), \
                paddle.to_tensor(is_next,dtype='int64'), \
                paddle.to_tensor(seg,dtype='int64')
...
class LmDataLoader(object):
    ...
    def __iter__(self):
        while True:
            ...
            yield paddle.to_tensor(src,dtype='int64'), \
                paddle.to_tensor(tgt,dtype='int64'), \
                paddle.to_tensor(seg,dtype='int64')
...
class BilmDataLoader(object):
    ...
    def __iter__(self):
        while True:
            ...
            #     torch.LongTensor(seg)
            yield paddle.to_tensor(src,dtype='int64'), \
                paddle.to_tensor(tgt_forward,dtype='int64'), \
                paddle.to_tensor(tgt_backward,dtype='int64'), \
                paddle.to_tensor(seg,dtype='int64')
